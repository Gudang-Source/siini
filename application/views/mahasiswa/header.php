...
<li <?php if($this->uri->segment(2)=="biodata" || $this->uri->segment(2)=="biodata") { echo 'class="active"'; } ?>>
<a href="<?=base_URL()?>mahasiswa/biodata"><i class="fa fa-user"></i> <span>Bio Data</span></a>
</li>
