			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li <?php if($this->uri->segment(2)=="mahasiswa" || $this->uri->segment(2)=="mahasiswa_tambah" || $this->uri->segment(2)=="mahasiswa_edit" || $this->uri->segment(2)=="dosen" || $this->uri->segment(2)=="dosen_tambah" || $this->uri->segment(2)=="dosen_edit" || $this->uri->segment(2)=="user"|| $this->uri->segment(2)=="user_tambah" || $this->uri->segment(2)=="user_edit") { echo 'class="treeview active"'; } else { echo 'class="treeview"'; } ?>>
						<a href="javascript:void(0)"><i class="fa fa-database"></i> <span>Master Data</span>
					...
					<li <?php if($this->uri->segment(2)=="krs" || $this->uri->segment(2)=="krs_tambah" || $this->uri->segment(2)=="krs_edit") { echo 'class="active"'; } ?>>
						<a href="<?=base_URL()?>admin/krs"><i class="fa fa-calculator"></i> <span>KRS</span></a>
					</li>

					<li class="header">LAPORAN</li>

					<li <?php if($this->uri->segment(2)=="mahasiswa" || $this->uri->segment(2)=="mahasiswa_tambah" || $this->uri->segment(2)=="mahasiswa_edit" || $this->uri->segment(2)=="dosen" || $this->uri->segment(2)=="dosen_tambah" || $this->uri->segment(2)=="dosen_edit" || $this->uri->segment(2)=="user"|| $this->uri->segment(2)=="user_tambah" || $this->uri->segment(2)=="user_edit") { echo 'class="treeview active"'; } else { echo 'class="treeview"'; } ?>>
						<a href="javascript:void(0)"><i class="fa fa-database"></i> <span>Laporan</span>
							<span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
						</a>
						...
						<ul class="treeview-menu">
							...
							<li <?php if($this->uri->segment(2)=="mahasiswa" || $this->uri->segment(2)=="mahasiswa_tambah" || $this->uri->segment(2)=="mahasiswa_edit") { echo 'class="active"'; } ?>>
								<a href="javascript: w=window.open('<?=base_url()?>admin/laporan_mahasiswa', 'newwindow', 'width=1300, height=650'); w.focus(); w.print();"><i class="fa fa-file"></i> Mahasiswa</a>
							</li>

							<li <?php if($this->uri->segment(2)=="dosen" || $this->uri->segment(2)=="dosen_tambah" || $this->uri->segment(2)=="dosen_edit") { echo 'class="active"'; } ?>>
								<a href="javascript: w=window.open('<?=base_url()?>admin/Laporan_dosen', 'newwindow', 'width=1300, height=650'); w.focus(); w.print();"><i class="fa fa-file"></i> Dosen</a>
							</li>

							<li <?php if($this->uri->segment(2)=="user" || $this->uri->segment(2)=="user_tambah" || $this->uri->segment(2)=="user_edit") { echo 'class="active"'; } ?>>
								<a href="javascript: w=window.open('<?=base_url()?>admin/Laporan_matakuliah', 'newwindow', 'width=1300, height=650'); w.focus(); w.print();"><i class="fa fa-file"></i> Matakuliah</a>
							</li>

							<li <?php if($this->uri->segment(2)=="user" || $this->uri->segment(2)=="user_tambah" || $this->uri->segment(2)=="user_edit") { echo 'class="active"'; } ?>>
								<a href="javascript: w=window.open('<?=base_url()?>admin/Laporan_nilai', 'newwindow', 'width=1300, height=650'); w.focus(); w.print();"><i class="fa fa-file"></i> Nilai</a>
							</li>
