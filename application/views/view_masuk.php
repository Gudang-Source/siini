		...
		<div class="login-box">
			<div class="login-box-body">
				...
				<div class="form-group has-feedback">
					<input type="text" class="form-control" name="username" maxlength="20" placeholder="NIM / NID" required autofocus>
			...
			Hak Cipta &copy; 2018 &nbsp; <a href="<?=base_URL()?>"><strong>SIINI (Sistem Informasi Input Nilai)</strong></a>
			</div>
			<!-- /.footer -->		
			<hr>
